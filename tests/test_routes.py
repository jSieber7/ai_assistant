...
class TestChatCompletions:
    ...
    def test_chat_completion_success(self, client: TestClient, chat_request_data, mock_llm):
...
class TestStreamingChatCompletions:
    ...
    def test_streaming_chat_completion_success(self, client: TestClient, streaming_chat_request_data, mock_llm):
...
class TestChatCompletionErrorHandling:
    ...
    def test_chat_completion_openrouter_error(self, client: TestClient, chat_request_data, mock_openrouter_error):
    ...
    def test_chat_completion_wrong_content_type(self, client: TestClient, chat_request_data):
...
class TestAsyncChatCompletions:
    ...
    async def test_async_chat_completion(self, client: TestClient, chat_request_data, mock_llm):
    ...
    async def test_async_streaming_chat_completion(self, client: TestClient, streaming_chat_request_data, mock_llm):
